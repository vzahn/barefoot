...
/**
 * Factory for creation of state candidates, which is {@link StateCandidate},
 * transitions, which is {@link StateTransition}, and samples, i.e.
 * {@link Sample}. A {@link Factory} instance enables dependency injection
 * during creation from their respective JSON representation.
 *
 * @param <C>
